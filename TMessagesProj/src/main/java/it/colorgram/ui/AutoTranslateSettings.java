...
public class AutoTranslateSettings extends BaseSettingsActivity {
    ...
    protected void onItemClick(View view, int position, float x, float y) {
        ...
        if (position == alwaysTranslateRow || position == neverTranslateRow) {
            ColorConfig.setAutoTranslate(position == alwaysTranslateRow);
            ...
            switch (ViewType.fromInt(holder.getItemViewType())) {
                ...
                case RADIO:
                    ...
                    if (position == alwaysTranslateRow) {
                        if (partial) {
                            radioCell.setChecked(ColorConfig.autoTranslate, true);
                        } else {
                            radioCell.setText(LocaleController.getString("AlwaysTranslate", R.string.AlwaysTranslate), ColorConfig.autoTranslate, true);
                        }
                    } else if (position == neverTranslateRow) {
                        if (partial) {
                            radioCell.setChecked(!ColorConfig.autoTranslate, true);
                        } else {
                            radioCell.setText(LocaleController.getString("NeverTranslate", R.string.NeverTranslate), !ColorConfig.autoTranslate, true);
                        }
                    }
                    break;
                case SETTINGS:
