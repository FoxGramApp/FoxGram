...
public class BlurIntensity extends FrameLayout {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawText("" + ColorConfig.blurIntensity, getMeasuredWidth() - AndroidUtilities.dp(39), AndroidUtilities.dp(28), textPaint);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        sizeBar.setProgress((ColorConfig.blurIntensity - startIntensity) / (float) (endIntensity - startIntensity));
    }
