...
public class DcStyleSelector extends LinearLayout {
    ...
    private void drawStyleSelected(Canvas canvas, int x, int y, int w, int h, int maxW, int maxH, int color) {
        ...
        if (ColorConfig.dcStyleType == 1 || ColorConfig.dcStyleType == 0) {
        ...
        if (ColorConfig.dcStyleType == 2 || ColorConfig.dcStyleType == 0) {
    ...
    public static int getStyleSelected() {
        return ColorConfig.dcStyleType == 0 ? (ColorConfig.buttonStyleType == 5 ? 1 : 2) : ColorConfig.dcStyleType;
    }
