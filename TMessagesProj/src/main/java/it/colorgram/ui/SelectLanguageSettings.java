...
public class SelectLanguageSettings extends BaseSettingsActivity {
    ...
    protected void onItemClick(View view, int position, float x, float y) {
        if (position != languageHeaderRow) {
            ...
            ColorConfig.setTranslationTarget(selectedLanguage);
            finishFragment();
        }
    }
    ...
    private void fixMostImportantLanguages(String appLanguage) {
        ...
        if (!ColorConfig.translationTarget.equals("app")) {
            int indexLangSelected = targetLanguages.indexOf(ColorConfig.translationTarget);
        ...
        protected void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position, boolean partial) {
            switch (ViewType.fromInt(holder.getItemViewType())) {
                case TEXT_RADIO:
                    ...
                    boolean isSelectedLanguage = ColorConfig.translationTarget.equals(targetLanguages.get(position - languagesStartRow));
