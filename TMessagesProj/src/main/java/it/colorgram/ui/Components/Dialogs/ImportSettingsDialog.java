...
public class ImportSettingsDialog extends BottomSheet {
    ...
    public ImportSettingsDialog(BaseFragment fragment, MessageObject messageObject) {
        ...
        difference = ColorConfig.getDifferenceBetweenCurrentConfig(messageObject).size();
        ...
        if (ColorConfig.isLegacy(messageObject)) {
        ...
        buttonTextView.setOnClickListener(view -> {
            dismiss();
            int differenceUI = ColorConfig.getDifferenceUI(messageObject);
            ColorConfig.restoreBackup(messageObject);
            ...
            fragment.getNotificationCenter().postNotificationName(NotificationCenter.mainUserInfoChanged);
            ColorConfig.doRebuildUIWithDiff(differenceUI, fragment.getParentLayout());
