...
public class UpdateSignaling {
    public static void checkWasUpdated() {
        String oldBuildVersion = ColorConfig.oldBuildVersion;
        ...
        if ((oldBuildVersion != null && oldBuildVersion.equals(ColorConfig.currentNotificationVersion())) || BuildConfig.DEBUG_PRIVATE_VERSION) {
            return;
        }
