...
public class ImportSettingsDialog extends BottomSheet {
    ...
    public ImportSettingsDialog(BaseFragment fragment, MessageObject messageObject) {
        ...
        difference = FoxConfig.getDifferenceBetweenCurrentConfig(messageObject).size();
        ...
        if (FoxConfig.isLegacy(messageObject)) {
        ...
        buttonTextView.setOnClickListener(view -> {
            dismiss();
            int differenceUI = FoxConfig.getDifferenceUI(messageObject);
            FoxConfig.restoreBackup(messageObject);
            ...
            fragment.getNotificationCenter().postNotificationName(NotificationCenter.mainUserInfoChanged);
            FoxConfig.doRebuildUIWithDiff(differenceUI, fragment.getParentLayout());
