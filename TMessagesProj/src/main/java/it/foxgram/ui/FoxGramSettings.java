...
public class FoxGramSettings extends BaseSettingsActivity {
    ...
    private class ListAdapter extends BaseListAdapter {
            ...
            switch (ViewType.fromInt(holder.getItemViewType())) {
                ...
                case DETAILED_SETTINGS:
                    ...
                    if (position == supportTranslationRow) {
                        ...
                        textDetailCell.setTextAndValueAndIcon(appName, updateInfo, R.drawable.fox_logo, false);
                    } else if (position == sourceCodeRow) {
        ...
        public ViewType getViewType(int position) {
            ...
            } else if (position == foxRow || position == supportTranslationRow || position == sourceCodeRow ||
