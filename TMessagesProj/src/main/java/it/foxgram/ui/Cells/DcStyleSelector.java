...
public class DcStyleSelector extends LinearLayout {
    ...
    public static int FOXGRAM_DC = 2;
    ...
    private void drawStyleSelected(Canvas canvas, int x, int y, int w, int h, int maxW, int maxH, int color) {
        ...
        if (FoxConfig.dcStyleType == 1 || FoxConfig.dcStyleType == 0) {
        ...
        if (FoxConfig.dcStyleType == 2 || FoxConfig.dcStyleType == 0) {
    ...
    public static int getStyleSelected() {
        return FoxConfig.dcStyleType == 0 ? (FoxConfig.buttonStyleType == 5 ? 1 : 2) : FoxConfig.dcStyleType;
    }
