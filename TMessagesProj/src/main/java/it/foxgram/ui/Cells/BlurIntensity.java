...
public class BlurIntensity extends FrameLayout {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawText("" + FoxConfig.blurIntensity, getMeasuredWidth() - AndroidUtilities.dp(39), AndroidUtilities.dp(28), textPaint);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        sizeBar.setProgress((FoxConfig.blurIntensity - startIntensity) / (float) (endIntensity - startIntensity));
    }
