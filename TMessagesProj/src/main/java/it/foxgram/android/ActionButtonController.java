...
public class ActionButtonController {
    ...
    public static boolean canShowTopActions(TLRPC.Chat currentChat, boolean editItemVisible, boolean isTopic) {
        return (!canShowShortcuts(currentChat, isTopic) || !editItemVisible) && (FoxConfig.buttonStyleType == 5 || isTopic);
    }
    ...
    public static boolean canShowButtons(boolean isTopic) {
        return FoxConfig.buttonStyleType == 5 || isTopic;
    }

    public static boolean canShowShortcuts(TLRPC.Chat currentChat, boolean isTopic) {
        return (FoxConfig.smartButtons && (ChatObject.hasAdminRights(currentChat) || currentChat != null && currentChat.megagroup && ChatObject.canChangeChatInfo(currentChat))) && !isTopic;
    }
