    ...
    public View createView(final Context context) {
        ...
        if (onlySelect) {
            ...
            if (isArchive()) {
                ...
                actionBar.setTitle(actionBarDefaultTitle = FoxTextUtils.getTitleText(), statusDrawable);
        ...
        if (!onlySelect && initialDialogsType == 0) {
            ...
            selectedCountView = new View(context) {
                ...
                protected void onDraw(Canvas canvas) {
                    @SuppressLint("DefaultLocale") String text = String.format("%d", Math.max(1, selectedDialogs.size()));
