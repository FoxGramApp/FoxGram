...
public class GroupCreateActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, View.OnClickListener {
    ...
    private boolean isAllowLockChat;
    private boolean isNeverLockChat;
    ...
    public GroupCreateActivity(Bundle args) {
        ...
        isAllowLockChat = args.getBoolean("isAllowLockChat", false);
        isNeverLockChat = args.getBoolean("isNeverLockChat", false);
        ...
        if (isAlwaysShare || isNeverShare || addToGroup || isAllowLockChat || isNeverLockChat) {
            maxCount = 0;
        } else {
    ...
    public View createView(Context context) {
        ...
        if (chatType == ChatObject.CHAT_TYPE_CHANNEL) {
            ...
            } else if (isNeverLockChat) {
                actionBar.setTitle(LocaleController.getString("ManageLockedChats", R.string.ManageLockedChats));
            } else if (isAllowLockChat) {
                actionBar.setTitle(LocaleController.getString("ManageLockedChats", R.string.ManageLockedChats));
        ...
        if (isNeverShare || isAlwaysShare || addToGroup || isAllowLockChat || isNeverLockChat) {
    ...
    private void updateEditTextHint() {
        ...
        if (chatType == ChatObject.CHAT_TYPE_CHANNEL) {
            ...
            } else if (isAlwaysShare || isNeverShare || isAllowLockChat || isNeverLockChat) {
        ...
        if (alert && addToGroup) {
            ...
            if (chatType == ChatObject.CHAT_TYPE_CHANNEL) {
                ...
                if (addToGroup) {
                    ...
                    if (isAlwaysShare || isNeverShare || isAllowLockChat || isNeverLockChat) {
                        if (delegate != null) {
    ...
    public class GroupCreateAdapter extends RecyclerListView.FastScrollAdapter {
        ...
        public GroupCreateAdapter(Context ctx) {
            ...
            if (isNeverShare || isAlwaysShare || isAllowLockChat || isNeverLockChat) {
        ...
        public void searchDialogs(final String query) {
            ...
            searchAdapterHelper.queryServerSearch(null, true, isAlwaysShare || isNeverShare || isNeverLockChat || isAllowLockChat, false, false, false, 0, false, 0, 0);
            notifyDataSetChanged();

            if (!TextUtils.isEmpty(query)){
                Utilities.searchQueue.postRunnable(searchRunnable = () -> AndroidUtilities.runOnUIThread(() -> {
                    searchAdapterHelper.queryServerSearch(query, true, isAlwaysShare || isNeverShare || isNeverLockChat || isAllowLockChat, true, false, false, 0, false, 0, 0);
