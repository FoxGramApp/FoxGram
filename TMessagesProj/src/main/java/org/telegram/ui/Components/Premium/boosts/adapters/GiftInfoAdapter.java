                            ...
                            () -> {
                                ...
                                dialogFragment.setDelegate((fragment1, dids, message, param, topicsFragment) -> {
                                    ...
                                    for (int a = 0; a < dids.size(); a++) {
                                        ...
                                        baseFragment.getSendMessagesHelper().sendMessage(SendMessagesHelper.SendMessageParams.of(slugLink, did, null, null, null, true, null, null, null, true, 0, null, false, false));
                                    }
