    ...
    private ActionMode.Callback createActionCallback() {
        final ActionMode.Callback callback = new ActionMode.Callback() {
            ...
            public boolean onCreateActionMode(ActionMode mode, Menu menu) {
                ...
                if (FoxConfig.showTranslate) menu.add(Menu.NONE, TRANSLATE, 2, LocaleController.getString("TranslateMessage", R.string.TranslateMessage));
                return true;
            }
            ...
            private void updateTranslateButton(Menu menu) {
                ...
                if (FoxConfig.showTranslate) menu.getItem(2).setVisible(translateFromLanguage == null || !DoNotTranslateSettings.getRestrictedLanguages().contains(translateFromLanguage.split("-")[0]));
                /*
