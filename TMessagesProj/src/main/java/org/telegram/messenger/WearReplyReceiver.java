...
public class WearReplyReceiver extends BroadcastReceiver {
    ...
    private void sendMessage(AccountInstance accountInstance, CharSequence text, long dialog_id, int topicId, int max_id) {
        ...
        accountInstance.getSendMessagesHelper().sendMessage(SendMessagesHelper.SendMessageParams.of(text.toString(), dialog_id, replyToMsgId, null, null, true, null, null, null, true, 0, null, false, false));
        //TODO handle topics
        if (topicId == 0) {
